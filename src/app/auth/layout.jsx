...
export default function AuthLayout({ children }) {
  ...
  return (
    <main className={`sm:flex ${orientacion} sm:min-h-screen relative`}>
      ...
      <div className="relative h-40 w-full sm:w-1/2 sm:min-h-screen">
        <Image src="/auth-image.webp" objectFit="cover" layout="fill" alt="Cartagena" />
      </div>
      <div className="flex flex-col items-center justify-center sm:w-1/2 pt-12 sm:pt-0">{children}</div>
    </main>
  )
}

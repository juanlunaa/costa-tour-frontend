            ...
            <div className="container w-[90%] mx-auto">
                ...
                <div className="w-full flex">
                    <div className="w-[40%] lg:w-[50%] sm:w-[30%] flex flex-col justify-center items-center">
                        ...
                        <p className="text-xs sm:text-sm lg:text-xl ">
                            En Costa Tour, no solo te mostramos los lugares emblemáticos de Cartagena,
                            sino que te conectamos con su esencia. Queremos que vivas experiencias inolvidables,
                            desde las calles coloniales de la Ciudad Amurallada hasta las playas paradisíacas de Barú.
                        </p>
                    </div>
                    ...
                    <div className="w-[50%] sm:w-[45%] md:w-[50%]">
                        <div className="container w-[80%] mx-auto flex flex-col items-center">
                            ...
                            <p className="w-full text-xs sm:text-sm sm:w-[80%] md:w-[70%] mb-12 mt-5 md:text-base lg:text-xl">
                                En Costa Tour, te ayudamos a enfocarte en disfrutar, permitiéndote elegir actividades
                                exclusivas y acceder a información detallada de los mejores lugares en un solo lugar.
                                Además, brindamos soporte continuo para resolver cualquier imprevisto de manera rápida
                                y eficiente.
                            </p>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div className="w-full flex justify-center">
                        <p className="w-full text-xs sm:text-sm sm:w-[80%] md:w-[70%] mb-12 mt-5 md:text-base lg:text-xl">
                            Costa Tour nació en 2024 de un grupo de entusiastas del turismo
                            y la tecnología, con el objetivo de ofrecer experiencias seguras
                            y auténticas en Cartagena. Inspirados por la experiencia de un familiar
                            que fue estafado en su primer viaje, creamos una plataforma confiable para
                            evitar que otros turistas enfrenten problemas similares. Hoy seguimos
                            comprometidos con esa misión, trabajando junto a aliados locales para
                            mostrar lo mejor de la ciudad.
                        </p>
                    </div>
                ...
                <div className=" w-full flex justify-center mb-12">
                    ...
                    <Button className={` ${styleBtn}`}>
                        <Link href="/sobreNosotros/unete" className="w-full">
                            Se nuestro Aliado
                        </Link>
                    </Button>

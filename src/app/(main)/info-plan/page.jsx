  ...
  return (
    <div className="flex justify-center pt-16">
      <div className="container relative mt-20 w-[80%] mx-auto">
        <div>
          <h1 className="font-volkhov font-bold text-2xl sm:text-4xl">
        ...
        <div>
          <h1 className="font-volkhov font-bold sm:text-xl text-lg pb-3">
            Descripción
          </h1>
        ...
        <div>
          <h1 className="font-volkhov font-bold sm:text-xl text-lg py-5">
            Ubicación
          </h1>

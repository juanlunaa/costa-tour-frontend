...
export default async function ExtremePage() {
    const extremeBanner = <img src="/banner-extremo.png" className="w-full h-auto max-h-[75vh] max-w-7xl" />;
    const plans = await fetchAllPlans()
    const validPlans = Array.isArray(plans) ? plans : []
    const textShadow = clsx("[text-shadow:_0_3px_0_rgb(255_255_255_/_100%),_0_-3px_0_rgb(255_255_255_/_100%),_3px_0_0_rgb(255_255_255_/_100%),_-3px_0_0_rgb(255_255_255_/_100%)]")
        ...
        <div className="pt-20 relative">
            <div className="relative">
                ...
                <div className="absolute transform -translate-y-1/2 top-[45%] left-5 sm:left-7 md:left-9 lg:left-11">
                    <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-white tracking-wider" style={{ fontFamily: 'fantasy' }}>
                ...
                <div className="absolute transform -translate-y-1/2 top-[80%] left-3 sm:left-5 md:left-7 lg:left-9 text-center">
                    <h1 className="text-[0.48rem] sm:text-sm md:text-base lg:text-xl font-black text-white">
                        <span className="text-gray-200">
                            ...
                            experiencias únicas que solo<br />
                            encontrarás aquí
                        </span>
                    </h1>

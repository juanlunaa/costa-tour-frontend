            ...
            <div className="container relative mt-20 w-[80%] mx-auto dark:bg-gray-900">
                <div>
                    ...
                    <div className="flex items-center gap-1">
                        <span className="text-orange-400"><MdStars /></span>
                ...
                <div className="flex justify-between max">
                    <div>
                        ...
                        <p className="w-full max-w-lg mt-4">
                            ¡Descubre la adrenalina sobre ruedas con nuestra emocionante excursión en cuatrimotos!
                            Recorre los senderos menos transitados de Cartagena, donde la naturaleza se une con la
                            aventura. Siente la emoción de conducir una potente cuatrimoto mientras atraviesas caminos
                            de tierra, arenas doradas y exuberantes paisajes tropicales.Esta experiencia es perfecta
                            para quienes buscan una dosis de aventura y emoción. Bajo la guía de expertos locales, vivirás
                            momentos inolvidables, con paradas estratégicas en puntos panorámicos donde podrás admirar
                            vistas impresionantes de la costa caribeña. Ya sea que seas un conductor experimentado o
                            un principiante, te aseguramos una aventura segura y llena de diversión.

        ...
        <div className="pt-20 relative">
            <div className="relative">
                <div className="h-full py-16 flex justify-center flex-col items-center bg-[linear-gradient(to_right,hsl(0,0%,100%,14%),hsl(197,71%,90%,61%)_25%,hsl(0,0%,100%,14%),hsl(32,71%,90%,61%),hsl(0,0%,100%,14%))]">
                    <h1 className="font-anton font-bold text-6xl text-black">Discotecas Exclusivas y Gastro Bares</h1>
                    <p className="text-xl max-w-3xl text-center  text-black mt-12">
                        Explora y vive una experiencia nocturna inigualable, donde la alta cocina se fusiona
                        con la mejor música y ambiente. Encuentra los lugares más selectos para disfrutar,
                        recomendados por expertos locales
                    </p>
                </div>
                <div>
                    <CurvedSlider />

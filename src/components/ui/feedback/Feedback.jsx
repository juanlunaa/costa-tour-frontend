      ...
      <div className="rating grid  grid-cols-2 sm:grid-cols-2 gap-4 mt-5 ">
        <div>
          <div className="flex items-end gap-1">
            <span className="font-mulish ml-2 font-black text-2xl sm:text-3xl">
              4,30
            </span>
            <p className="font-mulish font-light text-xs sm:text-base">
              850 Reseñas
            </p>
          </div>
          <div className="mt-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[1fr_2fr] md:grid-cols-[0.7fr_2.5fr] sm:gap-4 gap-1 w-full border-[#E8EAEB] border-b-2 py-4 my-8">
          <div className="flex sm:gap-4 gap-3  items-start">
            ...
            <div>
              ...
              <div>
                <span className="flex items-center text-sm sm:text-base w-max">
                  Arlene McCoy
                  <BsCheckAll className="ml-1 text-[#7BBCB0] text-lg sm:text-xl" />
                </span>
                <p className=" font-mulish text-xs sm:text-sm text-[#778088]">
                  6 octubre 2024
                </p>
              </div>
            </div>
          ...
          <div>
            <div>
              <span className="font-mulish font-bold sm:text-base text-sm">
            ...
            <div className="flex gap-4">
              ...
              <div className="text-center flex justify-center px-2">
                <div className="flex justify-center flex-col items-center">
                  <span className="sm:text-sm md:text-base text-xs ">
                    Editar
                  </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[1fr_2fr] md:grid-cols-[0.7fr_2.5fr] sm:gap-4 gap-1 w-full border-[#E8EAEB] border-b-2 py-4 my-8">
          <div className="flex sm:gap-4 gap-3  items-start">
            ...
            <div>
              ...
              <div>
                <span className="flex items-center text-sm sm:text-sm w-max">
                  Arlene McCoy
                  <BsCheckAll className="ml-1 text-[#7BBCB0] text-lg sm:text-xl" />
                </span>
                <p className=" font-mulish text-xs sm:text-sm text-[#778088]">

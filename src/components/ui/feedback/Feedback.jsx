  ...
  return (
        ...
        <div>
            <div className="customer-review mt-12">
                <h1 className="text-lg sm:text-lg lg:text-xl dark:text-white">Reseña del cliente</h1>
            </div>

            <div className="rating grid  grid-cols-2 sm:grid-cols-2 gap-4 mt-5 ">
                <div>
                    <div className="flex items-end gap-1">
                        <span className="font-mulish ml-2 font-black text-2xl sm:text-3xl dark:text-white">4,30</span>
                        <p className="font-mulish font-light text-xs sm:text-base dark:text-white">850 Reseñas</p>
                    </div>
                    <div className="mt-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-[1fr_2fr] md:grid-cols-[0.7fr_2.5fr] sm:gap-4 gap-1 w-full border-[#E8EAEB] border-b-2 py-4 my-8">
                    <div className="flex sm:gap-4 gap-3  items-start">
                        ...
                        <div>
                            ...
                            <div>
                                <span className="flex items-center text-sm sm:text-base w-max dark:text-white">Arlene McCoy
                                    <BsCheckAll className="ml-1 text-[#7BBCB0] text-lg sm:text-xl dark:text-white" /></span>
                                <p className=" font-mulish text-xs sm:text-sm text-[#778088] dark:text-white">6 octubre 2024</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div>
                            <span className="font-mulish font-bold sm:text-base text-sm dark:text-white">Buen recorrido, muy bien organizado.</span>
                        </div>
                        <div className="flex gap-4">
                            <div className="mt-4">
                                <p className="text-[#767681] font-mulish text-xs sm:text-sm md:text-base leading-relaxed sm:leading-normal dark:text-white">
                            ...
                            <div className="text-center flex justify-center px-2">
                                <div className="flex justify-center flex-col items-center">
                                    <span className="sm:text-sm md:text-base text-xs dark:text-white">Editar</span>
                                    <BiEdit className="sm:text-2xl text-xl cursor-pointer dark:text-white" />
                                </div>
                            </div>
                        </div>
                    </div>

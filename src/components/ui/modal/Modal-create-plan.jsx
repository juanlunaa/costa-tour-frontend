              ...
              <div className="w-1/2">
                <div className="space-y-4">
                  <div>
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="SITIO_TURISTICO">
                          Sitios Turisticos
                        </SelectItem>
                        <SelectItem value="PLAYA">Playas</SelectItem>
                        <SelectItem value="ALOJAMIENTO">
                          Alojamientos
                        </SelectItem>
                  ...
                  <div>
                    ...
                    <Input type="number" min="1" id="priceMin" />
                  </div>

                  <div>
                    <Label htmlFor="priceMax">Rango maximo de dinero</Label>
                    <Input type="number" min="1" id="priceMax" />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="btns flex justify-between mt-10">
                      <Button
                        type="submit"
                        className="sm:w-[40%] sm:text-base w-[45%] text-xs bg-customBlue hover:bg-cyan-400 rounded-full"
                      >
                        Cancelar
                      </Button>

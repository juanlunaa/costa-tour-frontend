...
export default function SolicitudesAdmin() {
  const [solicitudes, setSolicitudes] = useState([
    {
      id: "1",
      asunto: "Solicitud de Nuevo plan",
      nombre: "Hotel Hilton",
      descripcion: "Lorem Ipsum es simplemente el texto de relleno.",
      seleccionada: false,
      leida: false,
      fechaEnvio: "2024-10-17 10:30 AM",
    },
    {
      id: "2",
      asunto: "Solicitud de Nuevo plan",
      ...
      seleccionada: false,
      leida: false,
      fechaEnvio: "2024-10-17 11:00 AM",
    },
    {
      id: "3",
      asunto: "Solicitud de Nuevo plan",
      ...
      seleccionada: false,
      leida: false,
      fechaEnvio: "2024-10-17 12:45 PM",
    },
    {
      id: "4",
      asunto: "Solicitud de Nuevo plan",
      ...
      seleccionada: false,
      leida: false,
      fechaEnvio: "2024-10-17 01:00 PM",
    },
  ])
        ...
        <ScrollArea className="h-[600px] w-full rounded-lg border shadow-customBoxShadow">
          {solicitudes.map((solicitud) => (
            <div key={solicitud.id}>
              <div
                className={`flex items-center gap-2 p-4  border rounded-md  cursor-pointer ${!solicitud.leida ? "bg-blue-100 dark:backdrop-blur-lg dark:bg-black/60 hover:border-black " : "bg-white dark:backdrop-blur-sm dark:bg-gray-900/30 hover:border-gray-400"}`}
              ...
              >
                ...
                <div className="flex w-full md:justify-between md:gap-2  flex-col md:flex-row items-start md:items-center ">
                  ...
                  <div>
                    <p
                      className={`text-xs sm:text-xs md:text-sm font-medium dark:text-white dark:font-bold ${!solicitud.leida ? "text-blue-600" : "text-gray-900"} truncate`}
                    >
                      {solicitud.asunto}
                    </p>
                  </div>
        ...
        {solicitudSeleccionada && (
          <div className="absolute max-h-[600px] h-full bg-white w-full p-4 border rounded-md dark:bg-gray-800 dark:text-white">
            ...
            <p className="text-gray-600 mb-2 dark:text-white">
              De: {solicitudSeleccionada.nombre}
            </p>
            ...
            <p className="text-gray-500 mb-4 dark:text-white">
              Enviado el:{" "}
              {new Date(solicitudSeleccionada.fechaEnvio).toLocaleString()}
            </p>

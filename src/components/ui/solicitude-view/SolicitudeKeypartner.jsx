...
export function SolicitudeKeyPartner() {
  const [solicitudeState, setSolicitudeState] = useState([
    ...
    },
    {
      ...
      nombre: "Hotel Caribe",
      review:
        "La solicitud fue rechazada debido a inconsistencias en la información proporcionada. Por favor, verifica y envíala de nuevo.",
      stado: "Rechazado",
      seleccionada: false,
      leida: false,
    ...
    },
    {
      ...
      review:
        "La solicitud está pendiente de aprobación, estamos revisando la información enviada.",
      stado: "Pendiente",
      seleccionada: false,
      leida: false,
            ...
            {solicitudeState.map((solicitud) => {
              ...
              return (
                <div key={solicitud.id} className="p-4">
                  <div
                    className={`flex flex-col gap-2 p-4  border rounded-md shadow-customBoxShadow ${
                      !solicitud.leida
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span
                        className={`rounded-full w-[22%] flex justify-center items-center h-8 ${bgColorState}`}
                      >
                        {solicitud.stado}
                      </span>
                    </div>

...
export const CreateAdminAccount = () => {
  ...
  return (
    <form onSubmit={onSubmit} className="grid grid-cols-1 gap-4 w-[85%] py-[4%] mx-auto">
      ...
      <button type="submit" className={`${styleLabels} bg-yellowProfile w-[50%] sm:w-[40%] mt-5 py-4`}>Crear Cuenta</button>
    </form>
  )
}
...
export default function FormCreateKeyPartner() {
    ...
    return (
        ...
        <div className="rounded-3xl bg-white shadow-customBoxShadow p-10 w-3/5 mb-12">
            <form>
                <h1 className="font-volkhov font-bold text-xl">Se nuestro aliado de actividades</h1>
                ...
                <ul role="list" className="mt-5 space-y-2 text-sm leading-3 text-gray-300">
                    <li className="text-sm text-gray-600">
                        <span className="flex gap-x-3 items-center"><BsCheckCircle /> Incluye un dígito {"("}1234{")"} y un carácter especial {"("}#%!.^{")"}</span>
                    </li>
                    <li className="text-sm text-gray-600">
                        <span className="flex items-center gap-x-3"><BsCheckCircle />Entre 8 y 30 caracteres</span>
                    </li>
                </ul>

                <h1 className="font-volkhov font-bold text-xl mt-5">Términos y condiciones</h1>
                <div className="mt-5 flex items-center">
                    <Checkbox className="mr-2" />
                    <a href="#" className="text-sm">He leído y acepto los términos y condiciones del aliado y la política de privacidad.</a>
                </div>

          ...
          <AccordionContent>
            <div>
              ...
              <p className="mt-2">
                ...
                Cl. 5 #6-49, Castillogrande, Cartagena de Indias, Provincia de
              ...
              <p className="mt-2">
                nota: La recogida es 30 minutos antes de la hora de inicio del
                tour. Detrás de este hospital, uno de nuestros empleados lo
                esperará. Tenga en cuenta que esta es una experiencia
                compartida. Todas las conjeturas deben estar en el punto de
                encuentro antes de que comience el recorrido. No podemos tener
                otros invitados esperando.
              </p>
              <div className="flex gap-2 items-center font-bold mt-2">
                <FaFlagCheckered />
                <span className="text-customBlue"> Lugar de Finalizcion</span>
              </div>

              <p className="mt-2">
                NUEVO HOSPITAL DE BOCAGRANDE Cl. 5 #6-49, Castillogrande,
        ...
        <AccordionItem value="item-4" className="border border-t-gray-700">
          ...
          <AccordionContent>
            <ul className="list-disc relative left-8 mt-3">
              ...
              <li>
                No apto para personas con problemas cardíacos o afecciones
                médicas graves
              </li>
              <li>Puede participar la mayoría de los viajeros</li>
              <li>Debe tener 16 años para conducir</li>
              <li>
                Esta experiencia requiere buen clima. Si se cancela por mal
                tiempo, se le ofrecerá otra fecha o un reembolso total.
              </li>
              <li>

...
export const Footer = () => {
  return (
    <div className="py-10 flex justify-around items-center bg-gradient-to-b from-customBlue to-white">
      <Image src="/logo.png" width={200} height={200} alt="Logo Costa Tour" />

      <div className="w-32">
        <h1 className={`${titleFont.className} font-bold`}>Compañia</h1>
        <Link href="#" className={`${textFont.className} text-wrap text-sm`}>
          Conviértete en un guía turistico para nosotros
        </Link>
      </div>
      ...
      <div>
        ...
        <div className="flex justify-between">
          ...
          <Link href="#" className="text-[#C23772]">
            <FaInstagram />
          </Link>
        </div>
      </div>

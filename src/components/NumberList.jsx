...
const data = [
    { number: 1, title: "Regístrate sin costo", description: "Llena un formulario rápido y fácil" },
    {
        number: 2, title: "Completa tu información",
        description: (
            <>
    ...
    { number: 3, title: "Sube tus planes", description: "Añade tus planes incluyendo los premium " },
    {
        number: 4, title: "Comienza a ganar",
        description: (
            <>
    ...
    {
        number: 5, title: "Canales de atención",
        description: (
            <>
        ...
        <div className="relative flex flex-col items-start mt-10 w-full sm:w-[60%]">
            {data.map((item, index) => (
                <div key={item.number} className="flex items-center mb-10 last:mb-0">
                    ...
                    <div className="ml-6">
                        <h3 className="text-base sm:text-xl font-bold text-black dark:text-white">{item.title}</h3>
                        <p className=" text-xs sm:text-sm md:text-base text-gray-800 dark:text-gray-200">{item.description}</p>
                    </div>
                </div>
            ))}
        </div>

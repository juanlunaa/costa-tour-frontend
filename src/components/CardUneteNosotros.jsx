    ...
    const list = [
        {
            ...
            description: "Podrás mostrar tus servicios a una audiencia amplia y destacar tus ofertas únicas, aumentando tu presencia en el mercado turístico local."
        },
        {
            id: 2,
            imageUrl: "/cardsimg/card2.png",
            title: "Ofertas únicas",
            description: "Desde actividades extremas como parapente, surf, tours culturales, hasta experiencias gastronómicas. Lo que sea, lo tendrás."
        },
        {
            id: 3,
            imageUrl: "/cardsimg/card3.png",
            title: "Gestión sencilla y rápida",
            description: "Nuestra plataforma te permite gestionar fácilmente tus planes básicos y premium. manteniéndote siempre al día con tus actividades."
        },
        {
            id: 4,
            imageUrl: "/cardsimg/card4.png",
            title: "Siempre a tu lado",
            description: "Te ofrecemos soporte  para ayudarte en cada paso del camino. Estamos aquí para que tú puedas enfocarte en lo que mejor haces: crear experiencias inolvidables para los turistas."
        }
    ]

...
export const CardSuscripcion = ({
  ...
  return (
    <div className="relative w-[95%] bg-transparent shadow-customBoxShadow rounded-3xl p-8 ring-1 ring-gray-900/10 sm:px-10 py-8">
      ...
      <ul
        role="list"
        className="mt-8 space-y-3 text-sm leading-3 text-gray-300 sm:mt-6"
      >
        {caracteristicas.map((caracteristica, index) => (
          <li key={index} className="flex gap-x-3 text-sm text-black">
            <BsCheckCircle

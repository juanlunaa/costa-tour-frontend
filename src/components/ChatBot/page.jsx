...
const ChatBotCostaTour = () => {
	...
	const flow = {
    start: {
      message: "¡Hola! Bienvenido a Costa Tour, donde te conectamos con las mejores experiencias en Cartagena. ¿En qué puedo ayudarte hoy?",
      options: [
    ...
    premium_info: {
      message: "El plan premium de Costa Tour te ofrece acceso exclusivo a experiencias únicas en Cartagena:\n\n" +
    ...
    explore_activities: {
      message: "En Costa Tour ofrecemos una amplia gama de experiencias y actividades para que disfrutes al máximo tu visita a Cartagena:\n\n" +
               "• Playas paradisíacas\n" +
    ...
    discounts_promos: {
      message: "En Costa Tour, siempre tenemos ofertas especiales para nuestros clientes:\n\n" +
    ...
    beaches_info: {
      message: "Cartagena cuenta con hermosas playas de arena blanca y aguas cristalinas. Algunas de las más populares son:\n\n" +
               "• Playa Blanca\n" +
               "• Islas del Rosario\n" +
               "• Playa de Bocagrande\n\n" +
    ...
    restaurants_info: {
      message: "La gastronomía de Cartagena es rica y variada. Algunos de los mejores restaurantes incluyen:\n\n" +
      ...
      options: ["Sí, más información", "No, volver al menú de actividades"],
      function: (params) => handleUserInput("restaurantsChoice", params.userInput),
      path: (params) => {
        if (params.userInput === "Sí, más información") {
    ...
    accommodations_info: {
      message: "Cartagena ofrece una amplia variedad de alojamientos, desde hostales económicos hasta hoteles de lujo:\n\n" +
               "• Hotel Boutique Casa del Coliseo\n" +
               "• Sofitel Legend Santa Clara\n" +
               "• Casa San Agustín\n\n" +
               "¿Deseas ver más opciones de alojamiento en Cartagena?",
      options: ["Sí, más información", "No, volver al menú de actividades"],
      function: (params) => handleUserInput("accommodationsChoice", params.userInput),
      path: (params) => {
        if (params.userInput === "Sí, más información") {
    ...
    tourist_sites_info: {
      message: "Cartagena está llena de sitios históricos y culturales fascinantes:\n\n" +
               "• Castillo de San Felipe de Barajas\n" +
               "• Ciudad Amurallada\n" +
               "• Palacio de la Inquisición\n\n" +
               "¿Te gustaría explorar más sobre los sitios turísticos de Cartagena?",
      options: ["Sí, más información", "No, volver al menú de actividades"],
      function: (params) => handleUserInput("touristSitesChoice", params.userInput),
      path: (params) => {
        if (params.userInput === "Sí, más información") {
    ...
    redirect_to_premium_info: {
      message: "Te estamos redirigiendo a la página con información detallada sobre el plan premium...",
    ...
    redirect_to_beaches_info: {
      message: "Te estamos redirigiendo a la página con información detallada sobre las playas de Cartagena...",
      function: () => handleRedirectToActivityInfo('beaches'),
      path: "start"
    },
    redirect_to_restaurants_info: {
      message: "Te estamos redirigiendo a la página con información detallada sobre los restaurantes de Cartagena...",
      function: () => handleRedirectToActivityInfo('restaurants'),
      path: "start"
    },
    redirect_to_accommodations_info: {
      message: "Te estamos redirigiendo a la página con información detallada sobre alojamientos en Cartagena...",
      function: () => handleRedirectToActivityInfo('accommodations'),
      path: "start"
    },
    redirect_to_tourist_sites_info: {
      message: "Te estamos redirigiendo a la página con información detallada sobre los sitios turísticos de Cartagena...",
      function: () => handleRedirectToActivityInfo('tourist-sites'),
      path: "start"
    },
    // ... (El resto de los estados del flujo permanecen sin cambios)
	contact_help: {
		message: "Estamos aquí para ayudarte. Nuestro número de atención al cliente es: +57 (5) 123-4567\n\n" +
	  ...
	  faq_booking: {
		message: "Para hacer una reserva, puedes utilizar nuestra plataforma en línea o contactar directamente a nuestro equipo de atención al cliente. Te recomendamos registrarte primero para obtener los mejores descuentos y ofertas.\n\n¿Necesitas más ayuda?",
		options: ["Sí, tengo otra pregunta", "No, volver al menú principal"],
		function: (params) => handleUserInput("faqBookingChoice", params.userInput),
		path: (params) => params.userInput === "Sí, tengo otra pregunta" ? "faq" : "start"
	  },
	  faq_cancellation: {
		message: "Nuestras políticas de cancelación varían según el tour o actividad. En general, ofrecemos reembolso completo si cancelas con al menos 48 horas de anticipación. Para cancelaciones con menos de 48 horas, se aplica un cargo del 50%. Te recomendamos revisar los términos específicos al momento de hacer tu reserva.\n\n¿Necesitas más ayuda?",
		options: ["Sí, tengo otra pregunta", "No, volver al menú principal"],
		function: (params) => handleUserInput("faqCancellationChoice", params.userInput),
		path: (params) => params.userInput === "Sí, tengo otra pregunta" ? "faq" : "start"
	  },
	  faq_custom_tours: {
		message: "¡Sí! Ofrecemos tours personalizados para adaptarnos a tus preferencias y necesidades específicas. Contáctanos directamente para discutir tus ideas y te ayudaremos a crear una experiencia única en Cartagena.\n\n¿Necesitas más ayuda?",
		options: ["Sí, tengo otra pregunta", "No, volver al menú principal"],
		function: (params) => handleUserInput("faqCustomToursChoice", params.userInput),
		path: (params) => params.userInput === "Sí, tengo otra pregunta" ? "faq" : "start"
	  },
	  email_support: {
		message: "Para recibir soporte por correo electrónico, por favor escribe a support@costatour.com. Nuestro equipo te responderá en un plazo máximo de 24 horas.\n\n¿Necesitas más ayuda?",
		options: ["Sí, tengo otra pregunta", "No, volver al menú principal"],
		function: (params) => handleUserInput("emailSupportChoice", params.userInput),
		path: (params) => params.userInput === "Sí, tengo otra pregunta" ? "contact_help" : "start"
	  },
  };
		...
		<div>
			<ChatBot
				settings={{
					...
					footer: {
						text: (<span key={2} style={{ fontWeight: "bold" }}> Hola</span>)
					},
					header: {
						avatar: "/logos/avatar-chat.png",
						title: (<span style={{ fontWeight: "bold", display: "flex", alignItems: "center" }}>StarklyAI</span>)
					},
